...
|---|---|---|
| V1F0 | branch/authority reconciliation and coder gap audit | pending |
| V1F1 | exact pre-denoiser checkpoint, maturity crossing, and early stop | pending |
| V1F2 | exact replay, disjoint forks, and resumed batch parity | pending |
| V1F3 | typed partial-entry state, config, hashing, and seed contracts | pending |
| V1F4 | complete continuations, root value, controls, and fresh facade construction | pending |
| V1F5 | v0 admission mapping, artifacts, resume, and cost ledger | pending |
| V1F6 | production driver, launcher reuse, docs, and regression closure | pending |
| V1F7 | two real deployment canaries | pending |
...
2. `tests/inverse_folding/test_reference_flow_fusion_partial_entry.py`
...
pytest \
  ...
  tests/inverse_folding/test_reference_flow_fusion_partial_entry.py \
