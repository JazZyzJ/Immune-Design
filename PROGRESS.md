...
- **Uricase case study (standalone, not in main test set).** Files under `uricases/`:
  ...
  - **Q00511-only safety v1 (2026-07-13):** `inverse_folding/reference_flow/configs/uricase_q00511_active_site_safety_v1.yaml` freezes a 24-residue exact-WT safety-max union: the complete nine-residue UniProt active/binding core **K11/T58/D59/F160/R177/V228/Q229/N255/H257**, the full Q00511 experimental pocket/second shell (22 residues including that core), and selected PS00366 positions L153/S155. Scope is enforced for the exact 302-aa Q00511 sequence: source-sequence MD5 is checked before fixed-token construction and `projection_allowed: false` makes the family-manifest builder reject the preset. Generated/refined candidates retain 24-anchor validation so the other 278 positions remain globally editable; the per-protein v0 manifest is unchanged.
  - **Q00511 round-1 rescue Order 3 v2 (selected, not yet purchased; 2026-07-24):** `Results/Wetlab/order3_v2/` contains 70 strict monomer+holo candidates allocated `Sfull_sig80/Sfull_sig90/Smid_sig80/Sfull_sigOFF/Smid_sig90 = 20/15/15/10/10`. Ranking uses co-primary ligand and tetramer axes plus 10% soft Interface I/II contact quality; 1R51 hotspot retention, shape complementarity, packstat, and low-weight dG/dSASA define the auxiliary. The set is source-unique and sequence-unique (minimum pairwise Hamming 36), retains 39/70 Order 3 v1 IDs, and is recorded by `cases/q00511_r1_rescue_order3_v2_20260724.yaml` (`status=selected`).
