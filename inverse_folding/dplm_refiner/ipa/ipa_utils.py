"""IPA utility functions adapted from MapDiff.
...
def cal_dihedrals(X, eps=1e-7):
    """Compute backbone dihedrals (phi/psi/omega) as cos/sin features.

    Returns shape ``[B, L, 6]`` ``= cat(cos(D), sin(D))``.
    """
...
class Linear(nn.Linear):
    """Linear layer with built-in nonstandard initializations."""
