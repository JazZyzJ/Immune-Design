...
- impact:
  ...
  - risk: low
  - confidence: 0.90
- status: done -- primary `transmission_demonstrated`; secondary inconclusive; `D>1` remains launch-disabled.
...
- refs:
  ...
  - The claim is narrow on purpose: ONE token steers the completion at `D=1` under this policy. It says nothing about whether the steering is toward better designs -- that is capability, and the mechanism-stage gates carry no capability authority.
